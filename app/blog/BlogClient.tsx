    ...
    <div className="max-w-screen-xl mx-auto px-6 md:px-8 lg:px-12">
      ...
      <div className="py-14 md:py-20 border-b border-slate-100 mb-12">
        <div className="max-w-2xl">
          ...
          <p className="text-slate-500 text-lg leading-relaxed max-w-xl">
            Expert guides, insider tips and honest advice from our local team in Marrakech.
          </p>
        </div>
      </div>
          ...
          {categories.map(cat => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[11px] font-semibold leading-tight whitespace-nowrap">{cat}</span>
      ...
      {filtered.length > 0 && (
        <p className="text-sm text-slate-400 mb-6">
          Showing <span className="font-semibold text-slate-600">{totalShowing}</span> of{" "}
          <span className="font-semibold text-slate-600">{filtered.length}</span> articles
        </p>
      )}
      ...
      {hasMore && (
        <div className="mt-10 mb-12 text-center">
          ...
          >
            Load More Articles <FaArrowRight className="w-3.5 h-3.5" />
          </button>
          <p className="text-slate-400 text-xs mt-2">
            Showing {totalShowing} of {filtered.length} articles
          </p>
        </div>
      )}
