...
// ---------------------------------------------------------------------------
const topics: Topic[] = [
  { label: "Tour Enquiry", icon: FaCompass },
  { label: "Custom Itinerary", icon: FaMap },
  { label: "Group Travel", icon: FaUsers },
  { label: "Hotel & Riad", icon: FaBed },
      ...
      >
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-6 md:px-8 lg:px-12 text-center py-16">
          ...
          <p className="text-slate-300 text-lg max-w-2xl mx-auto mb-10">
            Our team of local experts is on hand 7 days a week. Whether you have a quick question
            or need a full custom itinerary — we&apos;d love to hear from you.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      ...
                      <div>
                        <label htmlFor="travelFrom" className={labelCls}>Travel From</label>
                        <input
                          id="travelFrom"
                          name="travelFrom"
                          type="date"
                      ...
                      <div>
                        <label htmlFor="travelTo" className={labelCls}>Travel To</label>
                        <input
                          id="travelTo"
                          name="travelTo"
                          type="date"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        value={form.message}
                        onChange={handleChange}
                        placeholder="Tell us what you're planning, how many people, your dates, and any special requests..."
                    ...
                    <label className="flex items-start gap-3 cursor-pointer group">
                      ...
                      <span className="text-sm text-slate-600 group-hover:text-slate-800 transition">
                        I&apos;d like a call-back from the team
                      </span>
                    </label>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
              <h3 className="text-base font-extrabold text-slate-800 mb-4">Talk to Us</h3>
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">Mon–Sun 8am–8pm</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-8 h-8 bg-amber-50 rounded-lg flex items-center justify-center shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">Reply within 2 hours</p>
                  </div>
                </li>
              </ul>
            ...
            {/* Our Offices */}
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
              <h3 className="text-base font-extrabold text-slate-800 mb-4">Our Offices</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-slate-800">
                      Marrakech{" "}
                      <span className="text-xs font-normal text-amber-600 ml-1">Main Office</span>
                    </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-slate-800">
                      Fes{" "}
                      <span className="text-xs font-normal text-slate-400 ml-1">North Office</span>
                    </p>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5">
              <div className="flex items-center gap-2 mb-3">
                ...
                <p className="text-sm font-bold text-amber-800">Average Response Time</p>
              </div>
              <p className="text-xs text-amber-700 mb-3">
                Our team typically replies to every enquiry in under 2 hours during office hours.
              </p>
        ...
        <div className="max-w-screen-xl mx-auto px-6 md:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 flex flex-col gap-4">
              ...
              <div>
                <h3 className="font-extrabold text-slate-800 mb-2">Fully Protected</h3>
                <p className="text-sm text-slate-500 leading-relaxed">
                  All bookings are fully insured and covered by Moroccan tourism authority
                  regulations.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 flex flex-col gap-4">
              ...
              <div>
                <h3 className="font-extrabold text-slate-800 mb-2">24/7 Support</h3>
                <p className="text-sm text-slate-500 leading-relaxed">
                  Our on-ground team is reachable around the clock throughout your trip.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 flex flex-col gap-4">
              ...
              <div>
                <h3 className="font-extrabold text-slate-800 mb-2">No Hidden Fees</h3>
                <p className="text-sm text-slate-500 leading-relaxed">
                  The price you see is the price you pay. Full transparency from booking to return.
                </p>
              </div>
            </div>
          </div>
